...
var Room = (function () {
    ...
    Room.prototype.remove = function () {
        ...
        return new rxjs_1.Observable(function (observer) {
            ...
            message_1.Message.remove(_this.name).subscribe(function (x) { }, function (error) { return observer.error(new Error(error)); }, function () { return observer.complete(); });
        });
    };
    Room.prototype.messages = function () {
        return message_1.Message.list(this.name);
    };
    return Room;
}());
exports.Room = Room;
